...
const _vega_ProposalParameters = require('./../ProposalParameters/encode.js')
...
exports.encode = function encode(obj = {}, buf, byteOffset = 0) {
  ...
  if (obj.proposalParams)
    writer.bytes(2, _vega_ProposalParameters.encode(obj.proposalParams))
  if (obj.changes?.length)
    obj.changes.forEach((v) =>
      writer.bytes(3, _vega_BatchProposalTermsChange.encode(v))
    )
