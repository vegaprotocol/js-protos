...
export const PROPOSAL_ERROR_INVALID_SPOT = 46
export const PROPOSAL_ERROR_SPOT_PRODUCT_DISABLED = 47
export const PROPOSAL_ERROR_INVALID_SUCCESSOR_MARKET = 48
export const PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_FAILED = 49
export const PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_INVALID = 50
export const PROPOSAL_ERROR_GOVERNANCE_CANCEL_TRANSFER_PROPOSAL_INVALID = 51
export const PROPOSAL_ERROR_INVALID_MARKET_STATE_UPDATE = 52
export const PROPOSAL_ERROR_INVALID_SLA_PARAMS = 53
export const PROPOSAL_ERROR_MISSING_SLA_PARAMS = 54
export const PROPOSAL_ERROR_INVALID_PERPETUAL_PRODUCT = 55
export const PROPOSAL_ERROR_INVALID_REFERRAL_PROGRAM = 56
export const PROPOSAL_ERROR_INVALID_VOLUME_DISCOUNT_PROGRAM = 57
export const PROPOSAL_ERROR_PROPOSAL_IN_BATCH_REJECTED = 58
export const PROPOSAL_ERROR_PROPOSAL_IN_BATCH_DECLINED = 59
export const PROPOSAL_ERROR_INVALID_SIZE_DECIMAL_PLACES = 60
export const PROPOSAL_ERROR_INVALID_VOLUME_REBATE_PROGRAM = 61
export const PROPOSAL_ERROR_INVALID_PROTOCOL_AUTOMATED_PURCHASE = 62
