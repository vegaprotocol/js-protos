...
export const ACCOUNT_TYPE_ORDER_MARGIN = 29
export const ACCOUNT_TYPE_REWARD_REALISED_RETURN = 30
export const ACCOUNT_TYPE_BUY_BACK_FEES = 31
export const ACCOUNT_TYPE_REWARD_AVERAGE_NOTIONAL = 32
export const ACCOUNT_TYPE_REWARD_ELIGIBLE_ENTITIES = 33
export const ACCOUNT_TYPE_LOCKED_FOR_STAKING = 34
