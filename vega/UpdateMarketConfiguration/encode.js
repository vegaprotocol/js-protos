...
const { string, bool, uint64 } = require('protobuf-codec/encode/types')
...
exports.encode = function encode(obj = {}, buf, byteOffset = 0) {
  ...
  if (obj.tickSize) writer.bytes(12, obj.tickSize, string)
  if (obj.enableTransactionReordering)
    writer.varint(13, obj.enableTransactionReordering, bool)
  if (obj.allowedEmptyAmmLevels)
    writer.varint(14, obj.allowedEmptyAmmLevels, uint64)
