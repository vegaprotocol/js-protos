...
const PROPOSAL_ERROR_INVALID_MARKET_STATE_UPDATE = 52
const PROPOSAL_ERROR_INVALID_SLA_PARAMS = 53
const PROPOSAL_ERROR_MISSING_SLA_PARAMS = 54
const PROPOSAL_ERROR_INVALID_PERPETUAL_PRODUCT = 55
const PROPOSAL_ERROR_INVALID_REFERRAL_PROGRAM = 56
const PROPOSAL_ERROR_INVALID_VOLUME_DISCOUNT_PROGRAM = 57
const PROPOSAL_ERROR_PROPOSAL_IN_BATCH_REJECTED = 58
const PROPOSAL_ERROR_PROPOSAL_IN_BATCH_DECLINED = 59
const PROPOSAL_ERROR_INVALID_SIZE_DECIMAL_PLACES = 60
const PROPOSAL_ERROR_INVALID_VOLUME_REBATE_PROGRAM = 61
const PROPOSAL_ERROR_INVALID_PROTOCOL_AUTOMATED_PURCHASE = 62
