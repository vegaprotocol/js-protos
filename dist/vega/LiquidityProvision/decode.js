...
import { string, int64, uint64 } from 'protobuf-codec/decode/types'
import * as _vega_LiquidityOrderReference from './../LiquidityOrderReference/decode.js'
...
export function decode(buf, byteOffset = 0, byteLength = buf.byteLength) {
  ...
  for (const [field, { data }] of reader(buf, byteOffset, byteLength)) {
    switch (field) {
      ...
      case 11:
        field$status = _vega_LiquidityProvision_Status.decode(data)
        break
