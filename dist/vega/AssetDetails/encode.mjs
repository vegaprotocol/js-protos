...
import * as BuiltinAsset from "./../BuiltinAsset/encode.mjs"
import * as ERC20 from "./../ERC20/encode.mjs"
...
export function encode(obj = {}, buf, byteOffset = 0) {
  ...
  if (obj.source) {
    const _o = obj.source
    if (_o.builtinAsset) writer.bytes(101, BuiltinAsset.encode(_o.builtinAsset))
    if (_o.erc20) writer.bytes(102, ERC20.encode(_o.erc20))
  }
